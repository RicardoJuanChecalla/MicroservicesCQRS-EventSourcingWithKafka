    ...
    public class EventJsonConverter : JsonConverter<BaseEvent>
    {
        ...
        public override BaseEvent? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            ...
            return typeDiscriminator switch
            {
                ...
                nameof(MessageUpatedEvent) => JsonSerializer.Deserialize<MessageUpatedEvent>(json, options),
                ...
                nameof(CommetUpdatedEvent) => JsonSerializer.Deserialize<CommetUpdatedEvent>(json, options),
                nameof(CommetRemovedEvent) => JsonSerializer.Deserialize<CommetRemovedEvent>(json, options),
